...
description: Gabriel Paesano, apprenti spécialiste infrastructure & opérations chez Infomaniak Network SA, contributeur open source et photographe. Genève, Suisse.
...
- **10.2025:** Arrêt officiel de Windows et adieu au big tech
- **05.2026:** Début des contributions actives à l'OSS et création de logiciels
...
- **[The Olynthe Initiative](https://olynthe.org)**
  droits numériques & logiciel libre
...
Le matos : Nikon D7000 | GoPro hero 12 | Pixel 9 Pro XL

Voici quelques clichés que j'aime ! J'espère sincèrement qu'ils te plairont aussi :)

[![Un chat roux rôdant dans l'herbe mouillée de rosée](https://gabriel.olynthe.org/photos/01.jpg)](https://gabriel.olynthe.org/photos/01.jpg)

*01*

[![Une fleur de véronique en macro](https://gabriel.olynthe.org/photos/02.jpg)](https://gabriel.olynthe.org/photos/02.jpg)
...
[![La Voie lactée dans un ciel nocturne sombre](https://gabriel.olynthe.org/photos/04.jpg)](https://gabriel.olynthe.org/photos/04.jpg)

*04*

[![Un moineau domestique de profil, bien net](https://gabriel.olynthe.org/photos/05.jpg)](https://gabriel.olynthe.org/photos/05.jpg)
...
- **Téléphones:** Google Pixel, Fairphone, Nothing
- **Ordinateurs:** Framework, Apple, Dell
- **Appareils photo:** Nikon, Lumix, Fujifilm
- **Cartes DIY:** Raspberry Pi, Arduino, Flipper Zero
- **IDE:** Zed (Preview)

![Une baie serveur en désordre couverte de câbles emmêlés](https://gabriel.olynthe.org/messy_server_rack.jpg)

*Rassure-toi, c'est juste une image trouvée sur internet ; pas mon vrai homelab. Mais ça y ressemble pas mal.... Bref, passons ! photo : Kim Scarborough, Wikimedia Commons (CC BY-SA 2.0)*
...
```json
{
    ...
    "url": "https://gabriel.olynthe.org/fr/",
    "jobTitle": "apprenti spécialiste infrastructure & opérations chez Infomaniak Network SA",
    "sameAs": [
